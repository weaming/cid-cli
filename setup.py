...
setup(
    name=name,  # Required
    version=get_version("cid_cli.py"),  # Required
    # This is a one-line description or tagline of what your project does.
    description="CLI wrapper for py-cid for decoding CID",  # Required
